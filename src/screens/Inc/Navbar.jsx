...
<nav class="px-5 py-5 xl:py-0 lg:py-0 md:py-0 sm:py-5">
  ...
  <div class="inline-flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse w-fit ml-auto">
      ...
      <button type="button" class="text-white bg-[#28af58]  px-3 py-0  xl:px-8 xl:py-3 md:px-8 md:py-3 lg:px-8 lg:py-3 sm:px-3 sm:py-0 rounded-[10px] mr-0 ml-auto sign-up xl:mr-0 lg:mr-0 md:mr-0 sm:mr-0 text-[14px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[14px]">Sign Up</button>
